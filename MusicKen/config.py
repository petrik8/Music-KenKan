...
BG_IMAGE = getenv("BG_IMAGE", "https://telegra.ph/file/23a3b3708c7e1c04e1dfb.png")
admins = {}
...
PROJECT_NAME = getenv("PROJECT_NAME", "MUSIK KU")
OWNER = getenv("OWNER", "@kenkanasw")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/kenkannih/Music-KenKan")
